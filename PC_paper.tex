...
In the following subsections, we note previously known sources by querying the NASA/IPCA Extragalactic Database (NED)\footnote{\url{https://ned.ipac.caltech.edu/}} and the SIMBAD Astronomical Database (SIMBAD)\footnote{\url{http://simbad.u-strasbg.fr/simbad/}}. We include sources from the NRAO VLA Sky Survey, ROSAT All-Sky Faint Source Survey, ROSAT All-Sky Bright Source Survey, and the Sloan Digital Sky Survey. \peditorial{Not sure how to cite this since NED cited a few different data releases} We made note of x-ray and radio sources within $5'$ of the reported BCG pointing and other catalogs as pertinent to the individual cluster.
