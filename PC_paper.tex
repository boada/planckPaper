...
Thus while high-$z$ systems were expectedly missed by this (optical only) survey, high-$z$ clusters alone cannot account for the high number of still unconfirmed clusters. We expect further follow up observations with deep infrared imaging will be required to either confirm or place additional limits on putative high-$z$ clusters.
